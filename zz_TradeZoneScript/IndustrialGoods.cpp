        ...
        while (industrial_good != "DONE")
        {
            ...
            else if (industrial_good == "PRINT")
            {
                for (int i = 0; i < industrialGood.size(); i++) {
                    ...
                    fw << "        trigger_if = {" << endl;
                    fw << "            limit = {" << endl;
                    fw << "                NOT = { scope:player = { can_pay_price = add_industry_price } }" << endl;
                    ...
                    fw << "            limit = {" << endl;
                    fw << "                NOT = { scope:player = { can_pay_price = remove_industry_price } }" << endl;
                    fw << "            }" << endl;
                    fw << "            hidden:scope:player = { can_pay_price = remove_industry_price }" << endl;
                    fw << "        }" << endl;
                    fw << "    }" << endl;
                    fw << "    effect = {" << endl;
