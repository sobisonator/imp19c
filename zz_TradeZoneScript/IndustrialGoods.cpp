        ...
        while (industrial_good != "DONE")
        {
            ...
            else if (industrial_good == "PRINT")
            {
                for (int i = 0; i < industrialGood.size(); i++) {
                    ...
                    fw << "            }" << endl;
                    fw << "            custom_tooltip = {" << endl;
                    fw << "                text = industries_at_maximum_tt" << endl;
                    fw << "                INDUSTRY_governorship_total_industry_slots < INDUSTRY_governorship_used_industry_slots" << endl;
                    fw << "            }" << endl;
                    fw << "        }" << endl;
                    fw << "        trigger_if = {" << endl;
                    fw << "            limit = {" << endl;
                    fw << "                scope:player = {" << endl;
                    fw << "                    NOT = { can_pay_price = add_industry_price }" << endl;
                    fw << "                }" << endl;
                    fw << "            }" << endl;
                    fw << "            hidden:scope:player = { can_pay_price = add_industry_price }" << endl;
                    fw << "        }" << endl;
                    fw << "    }" << endl;
                    fw << "    effect = {" << endl;
                    fw << "        scope:player = {" << endl;
                    fw << "            pay_price = add_industry_price" << endl;
                    fw << "        }" << endl;
                    fw << "        save_scope_as = governorship_name" << endl;
                    fw << "        custom_tooltip = " << industrialGood.at(i) << "_button_tt" << endl;
                    fw << "        if = {" << endl;
                    fw << "            limit = {" << endl;
